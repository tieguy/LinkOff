// General features: Dark mode and Wide mode

// Dark mode colors (from https://github.com/sweaver2112/LinkedIn-dark-theme-hack)
...
/**
 * Main general handler - called on settings change
 */
export default function doGenerals(getRes) {
